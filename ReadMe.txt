Currency Exchange Rates Calculator (CERC) - v1.0

Simple and easy calculator for exchange rates. Calculate many different currencies with
this HTML 5 based web app.
